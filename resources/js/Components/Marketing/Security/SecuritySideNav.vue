<template>
    <nav
        v-if="show"
        class="security-side-nav fixed left-0 top-1/2 transform -translate-y-1/2 z-40 hidden lg:block"
...
const navItems = [
    ...
    { anchor: 'data', label: 'Data handling' },
    { anchor: 'access', label: 'Access & audit' },
    { anchor: 'automation', label: 'Guardrails' },
    { anchor: 'reliability', label: 'Reliability' },
    { anchor: 'vuln', label: 'Vulnerability reporting' },
