<template>
    <section id="faq" class="solution-faq py-20">
        <div class="marketing-container max-w-3xl mx-auto">
            ...
            <div v-if="faqs.length === 0" class="text-center text-muted">
                <p>No FAQs available for this solution.</p>
            </div>
            <div v-else class="space-y-4">
                ...
                >
                    <button
                        ...
                        :aria-controls="`solution-faq-${idx}`"
                    >
