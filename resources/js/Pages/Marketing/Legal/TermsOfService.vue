<template>
    <div class="marketing-dark min-h-screen">
        ...
        <main id="main-content" class="py-12 md:py-20">
            <LegalLayout>
                <template #hero>
                    <LegalHero :policy="terms" :last-updated="lastUpdated" />
                </template>
                ...
                <template #content>
                    <div class="legal-content">
                        ...
                        <div class="lg:hidden mb-8">
                            <LegalTOC :sections="terms.sections" />
                        </div>
                        
                        <div class="space-y-8">
                            <LegalSection
                                v-for="(section, idx) in terms.sections"
                                :key="idx"
                                :section="section"
                            />
                        </div>
                        <div class="mt-12 pt-8 border-t border-border">
                            ...
                            <p class="text-muted">
                                ...
                                <a :href="`mailto:${supportEmail}`" class="text-primary hover:underline">
                                    {{ supportEmail }}
                                </a>
                            </p>
                        </div>
