...
export default function BacklinkOpportunitiesEdit({ opportunity, categories }) {
    const { flash } = usePage().props;
    const [form, setForm] = useState({
        url: opportunity.url || '',
        pa: opportunity.pa ?? '',
        da: opportunity.da ?? '',
        site_type: opportunity.site_type || 'comment',
        status: opportunity.status || 'active',
        daily_site_limit: opportunity.daily_site_limit ?? '',
        category_ids: opportunity.categories?.map(c => c.id) || [],
    });
    ...
    const handleSubmit = (e) => {
        ...
        router.put(`/admin/backlink-opportunities/${opportunity.id}`, form, {
            preserveScroll: true,
            onSuccess: () => {
    ...
    return (
        <AdminLayout header={`Edit Opportunity: ${opportunity.url}`}>
