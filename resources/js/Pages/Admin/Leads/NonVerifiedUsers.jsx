                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-shrink-0">
                                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-amber-500/10 to-amber-600/10 border border-amber-500/20 flex items-center justify-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-[var(--admin-text-muted)] flex items-center gap-2">
                                        ...
                                        <span>Users who haven't verified their email</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="hidden sm:block">
                                <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-amber-500/5 to-amber-600/5 border border-amber-500/10 flex items-center justify-center">
                                    <svg className="w-16 h-16 text-amber-500/20" fill="currentColor" viewBox="0 0 24 24">
                ...
                <Card className="overflow-hidden">
                    ...
                    <div className="px-6 py-5 border-b border-[var(--admin-border)] bg-[var(--admin-hover-bg)]">
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            <div>
                                <h2 className="text-lg font-semibold text-[var(--admin-text)]">Non-Verified Users</h2>
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                ...
                                <div className="relative flex-1 lg:flex-initial">
                                    ...
                                    <input
                                        ...
                                        className="pl-10 pr-4 py-2 w-full lg:w-64 text-sm bg-[var(--admin-surface)] border border-[var(--admin-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 text-[var(--admin-text)] placeholder-[var(--admin-text-muted)] transition-all"
                                    />
                                </div>
                                ...
                                <select
                                    ...
                                    className="px-4 py-2 text-sm bg-[var(--admin-surface)] border border-[var(--admin-border)] rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 text-[var(--admin-text)] transition-all"
                                >
                                ...
                                {/* Export Button */}
                                <button className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-[var(--admin-text)] bg-[var(--admin-surface)] border border-[var(--admin-border)] rounded-lg hover:bg-[var(--admin-hover-bg)] hover:border-amber-500/50 transition-all">
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {filteredUsers.length > 0 ? (
                                        ...
                                        >
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="flex items-center gap-3">
                                                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center text-white font-semibold text-sm shadow-sm">
                        ...
                        <div className="text-center py-16">
                            ...
                            <p className="text-[var(--admin-text)] font-medium text-lg">No non-verified users found</p>
                            <p className="text-[var(--admin-text-muted)] text-sm mt-2">
                                {searchQuery || filterPlan !== 'all' 
                                    ? 'Try adjusting your search or filters'
                                    : 'All users have verified their email'
                                }
                            </p>
                        </div>
                    )}
                                        ...
                                        <Link
                                            ...
                                            className={`px-3 py-2 text-sm font-medium rounded-lg transition-all duration-150 ${
                                                link.active
                                                    ...
                                                    : 'bg-[var(--admin-surface)] text-[var(--admin-text)] hover:bg-[var(--admin-hover-bg)] border border-[var(--admin-border)] hover:border-amber-500/50'
                                            }`}
