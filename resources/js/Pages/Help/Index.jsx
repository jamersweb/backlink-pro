                ...
                <Card title="Quick Links">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="/documentation" className="p-4 border rounded-lg hover:bg-gray-50">
                            <h3 className="font-semibold text-gray-900 mb-2"><i className="bi bi-book"></i> Documentation</h3>
                        ...
                        <a href="/campaign/create" className="p-4 border rounded-lg hover:bg-gray-50">
                            <h3 className="font-semibold text-gray-900 mb-2"><i className="bi bi-rocket-takeoff"></i> Create Campaign</h3>
                        ...
                        <a href="/reports" className="p-4 border rounded-lg hover:bg-gray-50">
                            <h3 className="font-semibold text-gray-900 mb-2"><i className="bi bi-bar-chart-line"></i> View Reports</h3>
